...
class ProfessorAttendanceAdapter(private val professorAttendances: List<ProfessorAttendance>) : RecyclerView.Adapter<ProfessorAttendanceAdapter.ProfessorAttendanceViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProfessorAttendanceViewHolder {
    ...
    class ProfessorAttendanceViewHolder(var binding: ItemProfessorAttendanceBinding) : RecyclerView.ViewHolder(binding.root) {
